...
using playing_with_rapidapi.data;
using playing_with_rapidapi.Models;
using System;
using Vault;

namespace playing_with_rapidapi
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            app.UseSwagger();
            app.UseSwaggerUI(c => {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "Playing With rapidapi");
